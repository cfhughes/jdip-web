...
public class WorldFactory 
{
	...
	//cached Map Objects
	private java.util.Map<Variant,dip.world.Map> mapscache = new HashMap<Variant,Map>(); 
	...
	/*
	 * Create a map, or retrieve from cache
	 */
	public Map createMap(Variant variant) throws InvalidWorldException{
		dip.world.Map map = null;

		if (mapscache.containsKey(variant)){
			map = mapscache.get(variant);
		}else{
